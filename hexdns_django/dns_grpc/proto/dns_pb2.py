...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=b'\n\tdns.proto\x12\x0b\x63oredns.dns"\x18\n\tDnsPacket\x12\x0b\n\x03msg\x18\x01 \x01(\x0c\x32\x45\n\nDnsService\x12\x37\n\x05Query\x12\x16.coredns.dns.DnsPacket\x1a\x16.coredns.dns.DnsPacketB\x04Z\x02pbb\x06proto3',
)
...
_DNSPACKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="msg",
            full_name="coredns.dns.DnsPacket.msg",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
...
DnsPacket = _reflection.GeneratedProtocolMessageType(
    "DnsPacket",
    (_message.Message,),
    {
