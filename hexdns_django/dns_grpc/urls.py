...
urlpatterns = [
    ...
    path("rzone/<str:zone_id>/new_ds/", views.rzone.create_r_ds_record, name="create_r_ds_record"),
    ...
    path("rrecords/ds/<str:record_id>/", views.rzone.edit_r_ds_record, name="edit_r_ds_record"),
    path("rrecords/ds/<str:record_id>/copy/", views.rzone.copy_r_ds_record, name="copy_r_ds_record"),
    path("rrecords/ds/<str:record_id>/delete/", views.rzone.delete_r_ds_record, name="delete_r_ds_record"),
